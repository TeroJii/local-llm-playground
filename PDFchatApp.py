...
ollama = Ollama(base_url='http://localhost:11434', model='gemma:2b')
embedding_model = OllamaEmbeddings(base_url='http://localhost:11434', model='all-minilm')
...
def user_input(user_question):
    ...
    for i, message in enumerate(st.session_state.chatHistory):
        if i%2 == 0:
            ...
            st.write("Local Language Model: ", message.content)
def main():
